...
\subsection{Data}
UniFrac requires two pieces of data: A phylogenetic tree and a table of counts per inferred taxa per sample. This data is derived from a gene tag experiment, the most common of which is the 16S rRNA gene tag experiment for microbiome research \cite{tringe2008renaissance}. A gene tag experiment is run by amplifying the gene tag through PCR, and then sequencing the resulting amplicon.
