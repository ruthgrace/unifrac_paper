...
\begin{figure}[h]
\includegraphics[scale=0.5]{unifrac_distance.eps}
...
\begin{figure}[h]
\includegraphics[scale=0.7]{sample_migration.eps}
...
\begin{figure}[h]
\includegraphics[scale=0.7]{ellipses.eps}
...
\begin{figure}[h]
\includegraphics[scale=0.6]{weightings.eps}
